  ...
  return (
    <div className="mx-auto min-h-screen max-w-md px-6 pb-8 pt-16">
      ...
      <button
        ...
        onClick={handleNext}
        className="mt-8 w-full rounded-xl border border-primary bg-primary px-5 py-3 font-semibold text-text-on-primary transition hover:bg-primary-hover active:bg-primary-active disabled:cursor-not-allowed disabled:border-disabled-border disabled:bg-disabled-bg disabled:text-disabled-text"
      >
